...
try{_=JSON.parse(e)}catch(t){_={}}l=localStorage.simpleStorage?String(localStorage.simpleStorage).length:0}function i(){try{localStorage.simpleStorage=JSON.stringify(_),l=localStorage.simpleStorage?String(localStorage.simpleStorage).length:0}catch(e){return e}return!0}function o(){var e,t,r,a,n,m=1/0,l=0
...
try{e()}catch(c){}return{version:m,canUse:function(){return!!p},set:function(e,t,r){if("__simpleStorage_meta"==e)return!1
if(!_)return!1
if("undefined"==typeof t)return this.deleteKey(e)
r=r||{}
try{t=JSON.parse(JSON.stringify(t))}catch(a){return a}return _[e]=t,n(e,r.TTL||0),i()},get:function(e){return!!_&&(_.hasOwnProperty(e)&&"__simpleStorage_meta"!=e&&this.getTTL(e)?_[e]:void 0)},deleteKey:function(e){return!!_&&(e in _&&(delete _[e],n(e,0),i()))},setTTL:function(e,t){return!!_&&(n(e,t),i())},getTTL:function(e){var t
